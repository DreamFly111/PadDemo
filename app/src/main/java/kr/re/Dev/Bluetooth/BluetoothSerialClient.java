...
/**
 * BluetoothSerialClient 블루투스를 이용한 시리얼 통신을 간편하게~ :)
 * 
 * www.dev.re.kr
 * 
...
public class BluetoothSerialClient {
	...
	/**
	 * 연결을 닫고 자원을 해지한다. 앱 종료시 반드시 호출해 줘야 한다.
	 */
	public void claer() {
		close();
	 ...
	 * @param context
	 *            activity
	 * @param onBluetoothEnabledListener
	 *            블루투스 on/off 에 대한 이벤트.
	 */
	 ...
	 * @param context
	 * @param device
	 *            블루투스 디바이스. {@link } 또는 {@link } 를 통하여 가져온 블루투스 디바이스 인스턴스.
	 * @param bluetoothStreamingHandler
	 *            블루투스 스트리밍 핸들러.
	 * @return 만약 블루투스를 사용할 수 없는 상태라면 false. {@link } 를 통하여 블루투스를 사용 가능한 상태로 만들어줘야 한다.
	 */
